...
class AprendizajeDivi extends StatelessWidget {
  const AprendizajeDivi({Key? key}) : super(key: key);
  ...
  Widget botones(context) {
    return Container(
      ...
      child: Column(
          ...
          children: <Widget>[
            botonTema(context,const Color.fromRGBO(145, 99, 203, 1),'Truco 1','DivTruco1'),
